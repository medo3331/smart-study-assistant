...
export async function freelanceAgent(
  ...
  try {
    ...
    return { ok: false, agent: AGENT_ID, code: "FREELANCE_ERROR", message: (e instanceof Error ? (e instanceof Error ? e.message : String(e)) : undefined) || String(e), retryable: true };
  }
}
