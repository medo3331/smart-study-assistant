...
export function routerSelectAgent(prompt: string, context?: Record<string, unknown>, hasImage?: boolean): AgentRouterDecision {
  ...
  const rules = [
    ...
    { id: "document_analyzer", keywords: ["ملف", "وثيقة", "pdf", "تحليل", "ملخص", "document", "analyze", "file", "لخص", " summarize"], conf: 0.92 },
    { id: "language_tutor", keywords: ["لغة", "إنجليزي", "عربي", "ترجمة", "language", "english", "arabic", "translate", "grammar", "صحح", "جملة"], conf: 0.85 },
