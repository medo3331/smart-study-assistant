...
- **فشل سريع في الصور (Fail-Fast)**: لو سيرفر Pollinations المجاني اتأخر أكتر من **20 ثانية** الطلب بيتلغي بـ `AbortController` وبينتقل فورًا للمزوّد اللي بعده في السلسلة — المستخدم ما يستناش كتير.
