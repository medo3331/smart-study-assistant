    ...
    <GlassCard glow className="p-5 sm:p-7">
      <div className="flex flex-col gap-6 md:flex-row md:items-center">
        ...
        <div className="min-w-0 flex-1">
          {subject && (
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[rgba(220,76,76,0.28)] bg-[rgba(220,76,76,0.13)] px-3 py-1 text-[11.5px] font-bold text-[#F5A25C]">
              <CellGlyph size={12} />
              {subject}
            </span>
          )}
          ...
          <div className="mt-5 flex flex-wrap items-center gap-2.5">
            <motion.button
              ...
              onClick={onStart}
              whileTap={{ scale: 0.97 }}
              className="inline-flex h-[46px] items-center justify-center gap-2 rounded-2xl bg-[#DC4C4C] px-5 text-[14.5px] font-bold text-white shadow-[0_6px_22px_rgba(220,76,76,0.38)] transition-colors hover:bg-[#F2745C] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#DC4C4C]"
            >
...
function MetaChip({
  ...
  const cls =
    tone === "amber"
      ...
      : tone === "violet"
        ? "border-white/[0.08] bg-white/[0.04] text-[#F5A25C]"
  ...
  return (
    <button
      ...
      className={
        ...
        (active
          ? "border-[rgba(220,76,76,0.35)] bg-[rgba(220,76,76,0.10)] text-[#F5A25C] [&_svg]:fill-[rgba(183,156,255,0.9)] [&_svg]:stroke-[#F5A25C]"
    ...
    <svg viewBox="0 0 250 250" fill="none" className="h-auto w-full">
      <defs>
        <radialGradient id="lessonCyto" cx="42%" cy="38%" r="75%">
          <stop offset="0%" stopColor="#DC4C4C" stopOpacity=".16" />
          <stop offset="60%" stopColor="#DC4C4C" stopOpacity=".05" />
          <stop offset="100%" stopColor="#DC4C4C" stopOpacity="0" />
        </radialGradient>
        <radialGradient id="lessonNuc" cx="38%" cy="35%" r="80%">
          <stop offset="0%" stopColor="#F5A25C" stopOpacity=".55" />
          <stop offset="100%" stopColor="#DC4C4C" stopOpacity=".18" />
        </radialGradient>
      </defs>
      <ellipse cx="125" cy="125" rx="112" ry="98" stroke="#DC4C4C" strokeOpacity=".45" strokeWidth="1.6" />
      <ellipse cx="125" cy="125" rx="104" ry="90" stroke="#DC4C4C" strokeOpacity=".16" strokeWidth="1" />
      <ellipse cx="125" cy="125" rx="103" ry="89" fill="url(#lessonCyto)" />
      <circle cx="105" cy="102" r="34" fill="url(#lessonNuc)" stroke="#F5A25C" strokeOpacity=".55" strokeWidth="1.4" />
      ...
      <path d="M138 120c14 4 24 14 26 26 M144 108c18 6 30 20 33 36 M136 132c10 3 17 10 20 18" stroke="#DC4C4C" strokeOpacity=".3" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  );
}
