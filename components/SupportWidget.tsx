...
export function SupportWidget() {
  ...
  // عشان مايتراكبش مع زرار الشات بوت.
  // وفي اللاندينج (/) بنخفيه (ومعه المساعد العائم في FloatingAssistant)
  // عشان تكون صفحة نظيفة للزائر — بيفضل ظاهر في كل باقي الصفحات
  // (الدخول، الدروس، صفحات الداشبورد، إلخ).
