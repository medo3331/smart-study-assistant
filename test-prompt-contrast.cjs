const GOALS_OPTIONS = [
  { id: "mastery", labelAr: "إتقان المادة من الصفر" },
  { id: "exam", labelAr: "الاستعداد لامتحان" },
  { id: "revision", labelAr: "مراجعة سريعة" },
  { id: "skill", labelAr: "اكتساب مهارة جديدة" },
  { id: "career", labelAr: "دعم مسارك المهني" },
];

const STYLE_OPTIONS = [
  { id: "simple", labelAr: "مبسط (أمثلة من الحياة)", emoji: "🍀" },
  { id: "detailed", labelAr: "تفصيلي (تعريف دقيق + تبسيط)", emoji: "📖" },
  { id: "fast", labelAr: "سريع ومباشر (نقاط مختصرة)", emoji: "🏃" },
];
